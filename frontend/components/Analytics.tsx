...
export const Analytics = ({isOpen, onClose}) => {
        ...
        for (const doc of userDocuments) {
          try {
            ...
            const billAnalysisPrompt = `
              ...
              Return EXACTLY in this format (maintain exact spacing and colons):
      ...
      {error ? (
        ...
        <div className="space-y-6">
          ...
          {Array.from(organizeByMonth().monthlyDocs)
            ...
            .map(([month, docs]) => (
            <div key={month} className="bg-gray-800/50 backdrop-blur-sm rounded-xl border border-gray-700 p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {docs.map((doc) => {
                  ...
                  return (
                    <div
                      key={doc.id}
                      className="relative bg-gray-900/50 p-4 rounded-lg border border-gray-700 hover:border-yellow-500/50 transition-colors"
                    >
